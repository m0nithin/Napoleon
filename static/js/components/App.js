...
function App() {
    ...
    return ( <
        ...
        div className = "dropdown-content-container" > { /* Links go here */ } <
        a href = 'https://knowyourmeme.com/memes/%D1%88%D0%B0%D0%B9%D0%BB%D1%83%D1%88%D0%B0%D0%B9-smurf-cat' > < img src = {
            kym
        }
        width = '80px' / > history < /a> <
        a href = 'https://flooz.xyz/trade/how-to-buy/0xfF836A5821E69066c87E268bC51b849FaB94240C' > < img src = {
            fl
        }
        width = '80px' / > tutorial < /a> <
        a href = 'https://twitter.com/smurfcateth' > < img src = {
            tw
        }
        width = '80px' / > memes < /a> <
        a href = 'https://t.me/smurfcateth' > < img src = {
            tg
        }
        width = '80px' / > smurf chat < /a> <
        /div> <
        /div> <
        div className = "dropdown" >
        <
        ...
        div className = "dropdown-content-container" > { /* Links go here */ } <
        a href = 'https://etherscan.io/token/0xff836a5821e69066c87e268bc51b849fab94240c' > < img src = {
            es
        }
        width = '80px' / > etherscan < /a> <
        a href = 'https://www.dextools.io/app/en/ether/pair-explorer/0x977c5fcf7a552d38adcde4f41025956855497c6d' > < img src = {
            dx
        }
        width = '70' / > dextools < /a> <
        a href = 'https://coinmarketcap.com/currencies/real-smurf-cat-eth/' > < img src = {
            cmc
        }
        width = '80px' / > coinmarketcap < /a> <
        a href = 'https://www.coingecko.com/en/coins/real-smurf-cat' > < img src = {
            cg
        }
        width = '80px' / > coingecko < /a> <
        /div> <
        /div> {
            /* <div className="dropdown">
        ...
        <
        a href = 'https://www.mexc.com/exchange/SMURFCAT_USDT?_from=search_spot_trade'
        className = 'item' >
        <
        img src = {
            mx
        ...
        span > MEXC < /span> <
        /a> <
        a href = 'https://www.bitget.com/spot/SMURFCATUSDT?type=spot'
        className = 'item' >
        <
        img src = {
            bg
        ...
        span > BitGet < /span> <
        /a> <
        a href = 'https://poloniex.com/trade/SMURFCAT_USDT?type=spot'
        className = 'item' >
        <
        img src = {
            pl
        ...
        span > Poloniex < /span> <
        /a> <
        a href = 'https://ascendex.com/en/cashtrade-spottrading/usdt/smurfcat'
        className = 'item' >
        <
        img src = {
            ae
